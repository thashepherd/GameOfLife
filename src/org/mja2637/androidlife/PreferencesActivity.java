...
public class PreferencesActivity extends PreferenceActivity {
    ...
    // bksx public
	public static final String OPTION_MINIMUM = "UNDERPOPULATION_VARIABLE";
	...
	// bksx works but the getInt() to get values crashes.
	public static void initMin(Context context)  {
