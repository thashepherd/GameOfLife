...
import android.util.Log;  // bks added
...
public class Life {
	...
	// bks added logMinimum() for debug.
    // you will see that the getMinimumVariable() function works to
    // get the 'current' minimum possibly changed by preferences.
    public void logMinimum( String msg ) {
        
        int minimum = Integer.parseInt(PreferencesActivity
                .getMinimumVariable(this._context));
        Log.i("Life", msg + ": current min == " + minimum);
    }
